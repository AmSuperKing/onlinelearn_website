  ...
  methods: {
    ...
    initListData () {
      ...
      if (userId) {
        ...
        ebookInfoApi
          .getAllEbookList(this.pageParams)
          .then(res => {
    ...
    commitChange () {
      if (this.changeForm.name && this.changeForm.desc) {
        if (this.changeForm.path) {
          ebookInfoApi
            .updateEbookInfo(this.changeForm)
            .then(res => {
              // console.log('updateEbookInfo', res.data)
    ...
    searchEbook () {
      if (this.pageParams.name ||
        ...
        ebookInfoApi
          .searchAllEbookByKey(this.pageParams)
          .then(res => {
    ...
    deleteCurr (row) {
      ebookInfoApi
        .delAllEbook(row)
        .then(res => {
          // console.log('delAllEbook', res.data)
          if (res.data.code) {
            this.initListData()
            this.$message.success(res.data.message)
          } else {
