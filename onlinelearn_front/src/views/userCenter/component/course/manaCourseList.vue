  ...
  methods: {
    ...
    initCourseData () {
      ...
      if (userId) {
        ...
        courseInfoApi
          .getAllCourseList(this.pageParams)
          .then(res => {
    ...
    commitChange () {
      if (this.changeForm.name && this.changeForm.desc) {
        if (this.changeForm.path) {
          courseInfoApi
            .updateCourseInfo(this.changeForm)
            .then(res => {
    ...
    searchCourse () {
      if (this.pageParams.name ||
        ...
        courseInfoApi
          .searchAllCourseByKey(this.pageParams)
          .then(res => {
