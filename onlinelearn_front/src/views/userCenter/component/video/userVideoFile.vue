  ...
  methods: {
    ...
    initListData () {
      ...
      if (userId) {
        ...
        userCenterApi
          .getVideoFileList(this.pageParams)
          .then(res => {
            // console.log('getVideoFileList数据列表', res.data)
