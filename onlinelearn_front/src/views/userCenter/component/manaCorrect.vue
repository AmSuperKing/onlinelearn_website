    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <el-input
              v-model.trim="pageParams.correctTitle"
              clearable
              size="mini"
              placeholder="模块标题"
      ...
      >
        ...
        >
          ...
          >
            <el-input
              v-model.trim="pageParams.correctContent"
              clearable
              size="mini"
              placeholder="问题描述"
              @change="changeSearchData"
      ...
      >
        ...
        >
          ...
          >
            <el-input
              v-model.trim="pageParams.correctContact"
              clearable
              size="mini"
              placeholder="反馈联系方式"
              @change="changeSearchData"
...
export default {
  ...
  methods: {
    ...
    initListData () {
      ...
      if (userId) {
        userCenterApi
          .allUserCorrect(this.pageParams)
          .then(res => {
    ...
    search () {
      if (this.pageParams.correctTitle ||
      this.pageParams.correctSection ||
      this.pageParams.correctContent) {
        this.pageParams.user = this.$cookie.get('userId')
        userCenterApi
          .searchCorrectByKey(this.pageParams)
          .then(res => {
