    ...
    <el-row>
      ...
      <el-col :xs="24" :sm="18" :md="18" :lg="18" :xl="18" class="serach-wrapper">
        <div class="input-wrapper">
          <el-input placeholder="请输入搜索词" v-model.trim="searchWord" clearable @clear="clearSearchWord" @keypress.native.enter="searchVideo">
      ...
      <el-col :xs="24" :sm="18" :md="18" :lg="18" :xl="18" class="content-wrapper">
        ...
        <el-row class="list-item" v-show="!noHaveContent">
          ...
          >
            <div  class="video-card">
              <router-link class="container-block" :to="'/videos/' + item.path" @click.native="addCountNum(item)">
        ...
        <el-row>
          <div v-show="noHaveContent" class="no-content">
            ...
            <el-button size="small" type="primary" class="show-all-btn" @click="getVideoList">返回全部视频列表</el-button>
          </div>
        </el-row>
      </el-col>
      <!-- 右侧 -->
          ...
          if (res.data) {
            ...
            if (this.currSortModel === '2') {
              if (this.videoList.length > 1) {
                this.videoList.sort(this.sortByNum('count_num'))
              }
            } else {
              if (this.videoList.length > 1) {
                this.videoList.sort(this.sortByName('name'))
              }
            }
