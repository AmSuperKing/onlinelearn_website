    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <el-input
              v-model.trim="pageParams.create_time"
              clearable
              size="mini"
              disabled
              placeholder="创建时间"
...
export default {
  ...
  methods: {
    ...
    searchQue () {
      if (this.pageParams.title || this.pageParams.userName) {
        this.pageParams.user = this.$cookie.get('userId')
        userCenterApi
          .searchQueByKey(this.pageParams)
          .then(res => {
