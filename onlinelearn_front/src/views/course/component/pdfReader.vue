  ...
  methods: {
      ...
      courseInfoApi
        ...
        .then(res => {
          ...
          if (res.data.data.length) {
            this.currFileInfo = res.data.data[0]
            // console.log('this.currFileInfo', this.currFileInfo)
            this.url = this.currFileInfo.source_path
            this.setCurrPageNum()
          }
        })
        .catch((e) => {})
    ...
    collectToHistory () {
      ...
      if (currUserId) {
        ...
        this.addParams.title = this.currFileInfo.source_name
